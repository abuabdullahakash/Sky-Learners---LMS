        ...
        {isSuccess ? (
          ...
          <div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                <label className="block text-xs sm:text-sm font-semibold mb-1 text-foreground/80">{t('nameLabel')}</label>
                <input 
                  type="text" 
                  value={name}
            ...
            <div className="space-y-3">
              <button type="button" onClick={() => handleSocialLogin(new GoogleAuthProvider())} className="w-full py-3 bg-background border border-foreground/15 text-foreground font-semibold rounded-xl hover:bg-foreground/5 transition-colors text-sm flex items-center justify-center gap-2 shadow-sm">
