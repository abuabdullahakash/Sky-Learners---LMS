    ...
    <div className="animate-in fade-in duration-500 space-y-6">
      ...
      <div className="relative w-full shadow-lg">
        ...
        <div className="relative z-10 px-8 py-8">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-2 drop-shadow-sm">Course Settings</h1>
          <p className="text-gray-300 text-sm font-medium">Edit course details, pricing, thumbnail and advanced configuration.</p>
        </div>
      </div>
