...
export const DEMO_COURSE_TITLES = [
  'প্রাথমিক গণিত আনন্দময় পাঠ (১ম শ্রেণি)',
  'ছোটদের ইংরেজি স্পোকেন ও ওয়ার্ড বিল্ডিং (২য় শ্রেণি)',
  'প্রাথমিক বিজ্ঞান ও পরিবেশ পরিচিতি (৩য় শ্রেণি)',
  'গণিত ফাউন্ডেশন ও অলিম্পিয়াড প্রস্তুতি (৪র্থ শ্রেণি)',
  'গণিত ফাউন্ডেশন ও অলিম্পিয়াড প্রস্তুতি (৪র্থ শ্রেণি)',
  'প্রাথমিক বৃত্তি ও সমাপনী চূড়ান্ত প্রস্তুতি (৫ম শ্রেণি)',
  'ক্লাস ৬ গণিত ও বিজ্ঞান মাস্টারক্লাস (নতুন কারিকুলাম)',
  'এসএসসি পদার্থবিজ্ঞান ও রসায়ন ক্র্যাশ কোর্স (১০ম শ্রেণি)',
  'HSC উচ্চতর গণিত ১ম ও ২য় পত্র (বিজ্ঞান বিভাগ)',
  'মেডিকেল বায়োলজি ও জিকে চূড়ান্ত এডমিশন প্রোগ্রাম',
  'কমপ্লিট ওয়েব ডেভেলপমেন্ট ও ফ্রিল্যান্সিং বুটক্যাম্প'
];
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg rounded-3xl bg-card border-2 border-orange-500/30 text-card-foreground shadow-2xl shadow-orange-500/20 overflow-hidden z-10 p-6 sm:p-8 my-auto"
          >
            {/* Ambient Corner Glow */}
