    ...
    <aside className="w-full flex flex-col justify-between min-h-full overflow-x-hidden pr-2">
      <div className="p-4 space-y-2">
        ...
        <Link
          ...
          className="flex items-center justify-between p-3 mb-3 bg-gradient-to-r from-orange-500/15 via-amber-500/10 to-transparent hover:from-orange-500/25 hover:to-orange-500/10 border border-orange-500/30 rounded-2xl transition-all group"
        >
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-orange-500 text-white flex items-center justify-center shadow-md shadow-orange-500/20 group-hover:scale-105 transition-transform">
              <LayoutDashboard className="w-4 h-4" />
            </div>
            <div>
              <p className="text-xs font-bold text-orange-600 dark:text-orange-400 leading-tight">Teacher Panel</p>
              <p className="text-[10px] text-foreground/60 leading-tight">Manage Courses</p>
            </div>
          </div>
          <span className="text-[10px] font-bold px-2 py-0.5 bg-orange-500/20 text-orange-600 dark:text-orange-400 rounded-full group-hover:translate-x-0.5 transition-transform">Go →</span>
        </Link>
      ...
      <div className="p-4 mt-auto border-t border-foreground/5 relative group">
        ...
        <div className="absolute bottom-full left-4 right-4 mb-2 bg-background border border-foreground/10 rounded-2xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-2 group-hover:translate-y-0 overflow-hidden z-50">
          <div className="p-2 space-y-1">
            <Link href="/teacher-dashboard" className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-orange-500/10 text-orange-600 dark:text-orange-400 text-sm font-bold transition-colors">
