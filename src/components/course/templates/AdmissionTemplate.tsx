          ...
          {course.introVideoUrl && (
            <a href={course.introVideoUrl} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-3 group cursor-pointer">
              <div className="relative w-14 h-14 flex items-center justify-center">
                ...
                <div className="relative w-14 h-14 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white group-hover:bg-red-500 group-hover:border-red-500 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-red-500/20">
                  <PlayCircle className="w-6 h-6 fill-current" />
                </div>
              </div>
              <span className="text-[10px] text-white/60 font-bold uppercase tracking-widest text-center group-hover:text-red-400 group-hover:-translate-y-1 transition-all duration-300 whitespace-pre-line">{t('watchTrailer')}</span>
            </a>
          )}
        </div>
